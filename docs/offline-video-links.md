...
| 실시간 밸런스게임 | `https://kt-cloud-balance-game.vercel.app/#/` | `assets/offline-videos/kt-cloud-balance-game.mov` |
| KAC 서류 확인 | `https://kac-doc-check.vercel.app/` | `assets/offline-videos/kac-doc-check.webm` |
| KAC 모의 테스트 | `https://kac-mock-test.vercel.app/` | `assets/offline-videos/kac-mock-test.webm` |
...
현재 `assets/offline-videos/`에 있는 `.mp4`, `.mov`, `.webm` 영상 파일 13개는 모두 위 링크에 매핑되어 있습니다. 같은 폴더의 PDF 안내 파일은 영상 플레이어 대상이 아니므로 별도 연결하지 않았습니다.
